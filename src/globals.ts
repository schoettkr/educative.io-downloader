...
export const BATCH_SIZE = 6; // Number of lessons will download concurrently
export const HTTP_REQUEST_TIMEOUT = 6000000; // Request will timeout after this milliseconds.
